...
//GET '/getForm'=>임임의 메세지 전송
app.get('/getForm', (req, res) => {
  //res.send('get 요청 성공!');
  console.log(req.query); //{ id: 'apple', pw: '1234' }:get방식으로 보내면사용자가 입력한 정보가 req.query형식으로 담겨서 옴
  res.render('result', { title: 'GET요청', userInfo: req.query });
});
